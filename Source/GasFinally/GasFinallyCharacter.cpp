...
AGasFinallyCharacter::AGasFinallyCharacter()
{
...
void AGasFinallyCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &AGasFinallyCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &AGasFinallyCharacter::Look);

		// Looking
		EnhancedInputComponent->BindAction(LookAction, ETriggerEvent::Triggered, this, &AGasFinallyCharacter::Look);
	}
	else
	{
...
void AGasFinallyCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGasFinallyCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void AGasFinallyCharacter::DoMove(float Right, float Forward)
{
...
void AGasFinallyCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void AGasFinallyCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void AGasFinallyCharacter::DoJumpEnd()
{
